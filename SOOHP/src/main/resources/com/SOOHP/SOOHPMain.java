...
import java.util.Random;
	...
	static Question currentQuestion = new Question();
...
///	            questionTextArea.setText(allQuestions.elementAt(1).getQuestionName());
	    ...
	    public Question scanLine(String line)
	    {
	      ...
	      ///  String a3 = lineScanner.next();
	        return new Question(qName,qText,a1,a2);
	    }
	    ...
	    public Question (String newQuestionName, String newQuestionText,String newAnswerOne,String newAnswerTwo){
